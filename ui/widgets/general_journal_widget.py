"""
ui/widgets/general_journal_widget.py
-------------------------------------
General Journal widget.
...
class GeneralJournalDialog(QDialog):
    """Add / edit / copy a General Journal entry."""
    ...
    def __init__(self, db_manager, parent=None, entry_data=None, is_copy=False):
        ...
        if is_copy:
            ...
            self.setWindowTitle('New Entry — General Journal')
        else:
...
class GeneralJournalWidget(BaseJournalWidget):
    TITLE         = 'GENERAL JOURNAL'
    DIALOG_CLASS  = GeneralJournalDialog
    GET_METHOD    = 'get_general_journal'
    ADD_METHOD    = 'add_general_journal_entry'
    DELETE_METHOD = 'delete_general_journal_entry'
    EXPORT_FOLDER = 'General Journal'
    EXPORT_FILE   = 'general_journal_report.xlsx'
    EXPORT_TITLE  = 'General Journal'
    IMPORT_TITLE  = 'Import General Journal'
